...
class SecretariasC
{
	...
	public function IngresarSecretariaC()
	{
		...
		if (isset($_POST["usuario-Ing"])) {
			...
			if (preg_match('/^[a-zA-Z0-9]+$/',$_POST["usuario-Ing"]) && preg_match('/^[a-zA-Z0-9]+$/',$_POST["clave-Ing"])) {
				...
				$resultado = SecretariasM::IngresarSecretariaM($tablaDB, $datosC);
	...
	//Vista de perfil de secretarias
	public function VerPerfilSecretariaC(){
		...
		echo '<tr>
				...
				echo'<td>
					...
					<a href="http://localhost:8082/clinica/perfil-S/'.$resultado["id"].'">
		...
		echo '<form method="post" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						...
						<h2>Contraseña:</h2>
						<input type="password" class="input-lg" name="claveP">
	...
	public function ActualizarPerfilSecretariaC(){
		...
		if (isset($_POST["idP"])) {
			...
			$datosC = array("id"=>$_POST["idP"], "usuario"=>$_POST["usuarioP"], "nombre"=>$_POST["nombreP"], "apellido"=>$_POST["apellidoP"], "clave"=>$_POST["claveP"], "foto"=>$rutaImg);
			...
			if ($resultado == true) {
				...
				echo '<script>
					...
					window.location = "http://localhost:8082/clinica/perfil-S/'.$_SESSION["id"].'";
	...
	public function VerSecretariasC(){
		...
		$resultado = SecretariasM::VerSecretariaM($tablaBD);
	...
	public function CrearSecretariaC(){
		...
		if(isset($_POST["rolS"])){
			...
			$datosC = array("rol"=>$_POST["rolS"], "apellido"=>$_POST["apellido"], "nombre"=>$_POST["nombre"], "usuario"=>$_POST["usuario"], "clave"=>$_POST["clave"]);
