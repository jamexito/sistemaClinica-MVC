...
class InicioC
{
	...
	public function MostrarInicioC(){
		...
		$resultado = InicioM::MostrarInicioM($tablaDB, $id);
		...
		echo '<form method="post" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						...
						<input type="hidden" class="input-lg" name="idI" value="'.$resultado["id"].'">
					...
					<div class="col-md-6 col-xs-12">
						...
						<br>
						<img src="http://localhost:8082/clinica/'.$resultado["logo"].'" width="200px;">			
						...
						<br>
						<img src="http://localhost:8082/clinica/'.$resultado["favicon"].'" width="200px;">			
	...
	public function ActualizarInicioC(){
		...
		if (isset($_POST["idI"])) {
			...
			$datosC = array("id"=>$_POST["idI"], "intro"=>$_POST["intro"],"horaE"=>$_POST["horaE"], "horaS"=>$_POST["horaS"], "telefono"=>$_POST["telefono"], "correo"=>$_POST["correo"], "direccion"=>$_POST["direccion"], "logo"=>$rutaLogo, "favicon"=>$rutaFavicon);

			$resultado = InicioM::ActualizarInicioM($tablaDB, $datosC);
