				...
				<div class="modal-body">
					...
					<div class="box-body">
						...
						echo '<div class="form-group">
								...
								<input type="hidden" name="idD" value="'.$resultado["id"].'">

								<input type="hidden" name="idP" value="'.$_SESSION["id"].'">
						...
						echo  '<div class="form-group">
									...
									<input type="hidden" name="idC" value="'.$consultorios["id"].'">
						...
						<div class="form-group">
							...
							<input type="date" class="form-control input-lg" id="fechaC" value="" readonly>
