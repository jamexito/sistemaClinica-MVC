			...
			<div class="box-header">
				...
				<form  method="POST">
					...
					<div class="col-md-6 col-xs-12">
						...
						<input type="text" class="form-control" name="consultoriosN" placeholder="Ingrese Nuevo Consultorio" required>
							...
							echo '<tr>
									...
									<td>
										...
										<div class="btn-group">
											...
											<a href="http://localhost:8082/clinica/E-C/'.$value["id"].'">
												
												<button class="btn btn-success"><i class="fa fa-pencil"></i> Editar</button>

											</a>

											<a href="http://localhost:8082/clinica/consultorios/'.$value["id"].'">
